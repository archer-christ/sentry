...
class ProjectTagsServiceHooksTest(AcceptanceTestCase):
    def setUp(self):
        ...
        self.path1 = '/settings/{}/{}/hooks/'.format(self.org.slug, self.project.slug)
        self.path2 = '/settings/{}/{}/hooks/new/'.format(self.org.slug, self.project.slug)
    ...
    def test_simple(self):
        ...
        self.browser.snapshot('project settings - service hooks - with entries')
